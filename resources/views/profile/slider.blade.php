            ...
            <div class="card-header pb-0 p-3">
                <div class="row">
                    <div class="col-md-8 d-flex align-items-center">
                        <h6 class="mb-3">Carrousel Control</h6>
                    </div>
                </div>
            </div>
                            ...
                            <div class="modal-body">
                                <form method='POST' action='{{route('slider.store')}}' enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control border p-2" id="title" required>
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="description" class="form-control border p-2" id="description" required>
                                        @error('description')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="image" class="form-control border p-2" id="image" required>
                                        @error('image')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editModal{{$slider->id}}" tabindex="-1" aria-labelledby="editModalLabel{{$slider->id}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form method='POST' action='{{route('slider.update', $slider->id)}}' enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="title" class="form-label">Title</label>
                                                        <input type="text" name="title" class="form-control border p-2" id="title" value="{{ $slider->title }}" required>
                                                        @error('title')
                                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                                        @enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="description" class="form-label">Description</label>
                                                        <input type="text" name="description" class="form-control border p-2" id="description" value="{{ $slider->description }}" required>
                                                        @error('description')
                                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                                        @enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <label for="image" class="form-label">Image</label>
                                                        <input type="file" name="image" class="form-control border p-2" id="image">
                                                        @error('image')
                                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                                        @enderror
                                                    </div>
