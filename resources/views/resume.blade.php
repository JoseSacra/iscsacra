...
<div class="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
    ...
    <div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
        <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
            ...
            --}}
            <div class="space-y-2">
                <h3 class="dark:text-white text-[22px] font-semibold"> Centro de Bachillerato Tecnológico Agropecuario </h3>
                <h4 class="dark:text-white text-[16px] font-semibold"> Tecnico en Informática </h3>
                    <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> 2005 - 2008 </p>
                    <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> At this institution I learned the basics of web development,
                        basic programming fundamentals in Visual Basic, and the procedure for performing preventive and corrective maintenance
                        on computer equipment. </p>
            ...
            <div class="space-y-2">
                ...
                <h4 class="dark:text-white text-[16px] font-semibold"> Ingeniero en Sistemas Computacionales </h4>
                    ...
                    <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> This institution is where I completed my undergraduate studies with a specialty
                        ...
                        contest with the design of images with animation, participation in an Expo Systems contest with the design of a virtual library
                        developed in the PHP programming language and MySQL was used as a database manager, as part of my training in this institution
